...
if __name__ == "__main__":
    ...
    padded_source = Tensor(np.ones((2, 2, 32000)), dtype=mindspore.float32)
    mixture_lengths = Tensor([32000, 32000], dtype=mindspore.int32)
    estimate_source_test = Tensor(np.ones((2, 2, 32000)), dtype=mindspore.float32)
    print("*" * 100)
    loss_test, max_snr_test, estimate_source_test, reorder_estimate_source_test = \
        my_loss(padded_source, estimate_source_test, mixture_lengths)
    print("_" * 100)
    print(loss_test.shape)
    print(max_snr_test.shape)
    print(estimate_source_test.shape)
    print(reorder_estimate_source_test.shape)
